...
import { Code2, Database, Layout, Settings, Server, Shield } from 'lucide-react';
...
const skillCategories = [
  ...
  },
  {
    title: 'Database',
    icon: Database,
    skills: ['PostgreSQL', 'MongoDB', 'Redis', 'Firebase', 'MySQL', 'Prisma']
  },
  {
    title: 'DevOps',
    icon: Settings,
  ...
  },
  {
    title: 'Security',
    icon: Shield,
    skills: ['OAuth', 'JWT', 'HTTPS', 'Web Security', 'Authentication', 'Authorization']
  }
];
